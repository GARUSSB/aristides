...
class Personal(models.Model):
    ...
    def __unicode__(self):
        return '%s (%s %s)' % (self.cedula, self.nombres, self.apellidos,self.cargo)


class Inacistencia(models.Model):
    TYPE_CHOICES = (("1", "ASISTENTE"), ("2", "INASISTENCIA JUSTIFICADA"), ("3", "INASISTENCIA INJUSTIFICADA"), ("4", "RETARDOS/TIEMPO"))
    ...
    def __unicode__(self):
        return '%s, Fecha: %s, Tipo:%s' % (self.personal, self.fecha, self.get_type())
